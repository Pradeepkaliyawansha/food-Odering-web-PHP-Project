...
$query = "SELECT * FROM items WHERE category='6'";
...
<div class="container-fluid" style="position: relative;">
    <img src="images/pizzas.jpg " alt="Snow " style="width:100%  ; height: 50vh; ">
    <div style="padding: 0px 0px 100px 0px ;  " class="carousel-caption ">
        <h2>Pizza</h2>
        <h3 style="color:#EDBB00 "><i><b>Italian pizza with the unique Sri Lankan taste</b></i></h3>
    ...
    <div class="row ">
        ...
        ?>
                ...
                <div id="regular_combo_blaster" class="input-group-append col-5">
                    ...
                    <select class="form-select portion" style="align-items:center" name="additional_item_quantity" id="<?php echo  'additional_item_quantity_' . $item[0]; ?>" onclick="AdditionalItem1()">
                        <option id="<?php echo $additional_item[0] . '_regular' ?> " sty value="" selected>select addon</option>
