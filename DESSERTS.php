...
$query = "SELECT * FROM items WHERE category='8'";
...
<div class="container-fluid" style="position: relative;">
    <img src="images/dessertss.jpg " alt="Snow " style="width:100%  ; height: 50vh; ">
    <div style="padding: 0px 0px 100px 0px ;  " class="carousel-caption ">
        <h2>Desserts</h2>
        <h3 style="color:#EDBB00 "><i><b>Don't forget! it is the most important of meal</b></i></h3>
    ...
    <div class="row ">
        ...
        ?>
                ...
                <!-- <?php //  foreach ($additional_items as $additional_item) { ?>
                    ...
                    <div class="input-group row ml-0.5 " style="justify-content: center;">
                       <div class="input-group-prepend flex-fill col-5 ">
                               ...
                               <input type="hidden"  value='0' id="<?php  //echo "$additional_item[1]"; ?>" name="additional_item" aria-label="Checkbox for following text input" />
            ...
            <!-- <div  id= "regular_combo_blaster" class="input-group-append col-5">
                          ...
                          <select name="additional_item_quantity" id="<?php //echo  'additional_item_quantity_'.$item[0];?>"  >
                             <option id=""value="0" selected>No addon</option>
