...
<div class="container-fluid" style="position: relative;">
    <img src="images/kottu.jpg " alt="Snow " style="width:100%  ; height: 50vh; ">
    <div style="padding: 0px 0px 100px 0px ;  " class="carousel-caption ">
        <h2>Kottu</h2>
        <h3 style="color:#EDBB00 "><i><b>National food of Sri Lankan street food lovers</b></i></h3>
        ...
        ?>
            ...
            <div  id= "regular_combo_blaster" class="input-group-append col-5">
                          ...
                          <!-- <select name="additional_item_quantity" id="<?php //echo  'additional_item_quantity_'.$item[0];?>" >
                             <option id="<?// echo $additional_item[0] .'_regular' ?> "value="0" selected>NO addon</option>
